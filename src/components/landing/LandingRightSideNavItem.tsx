...
import { Card, Modal, Nav, OverlayTrigger, Tooltip, NavDropdown } from 'react-bootstrap'
  ...
  return (
    <Nav navbar className="ms-auto">
      ...
      <Nav.Item>
        ...
        <Modal show={showRegistrationModal} centered onHide={() => setShowRegistrationModal(false)}>
