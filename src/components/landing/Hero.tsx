    ...
    >
      <Row className="justify-content-center align-items-center pt-8 pt-lg-10 pb-lg-9 pb-xl-0">
        <Col md={11} lg={8} xl={4} className="pb-7 pb-xl-9 text-center text-xl-start">
          <Button variant="outline-danger" className="mb-4 fs--1 border-2 rounded-pill">
          ...
          <p className="lead text-white opacity-75">
            With the power of Falcon, you can now focus only on functionaries for your digital
        ...
        <Col xl={{ span: 7, offset: 1 }} className="align-self-end mt-4 mt-xl-0">
          <Link href="">
            <a className="img-landing-banner">
              <Image className="img-fluid" src={isDark ? dashboardDark : dashboard} alt="" />
            </a>
          </Link>
        </Col>
      </Row>
